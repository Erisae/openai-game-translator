...
parser.add_argument('--openai_key', type=str, required=True, type=str, help='open ai translatio api key')
...
class translator(object):
    ...
    def xunfei_transcription(self):
        self.record_audio(self.filepath)
