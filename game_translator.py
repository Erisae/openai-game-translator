...
class translator(object):
    def __init__(self, transcription_model, filepath="", xunfei_appid="", xunfei_apikey="", xunfei_apisecret="", prerecorded=True, output_language="English"):
        self.filepath = ""
...
#     new_translator = translator(args.transcription_model, filepath=args.file, xunfei_appid=args.xunfei_appid, xunfei_apikey=args.xunfei_apikey, xunfei_apisecret=args.xunfei_apisecret, prerecorded=args.pre_recorded, output_language=args.output_language)
